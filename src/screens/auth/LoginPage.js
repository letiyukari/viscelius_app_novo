...
const LoginPage = () => {
    ...
    const handleNavigateToRegister = () => {
        if (role === 'patient') {
            ...
            navigate('/register-therapist/therapist');
        }
    };
    ...
    return (
      <div style={styles.container}>
        <div style={styles.loginBox}>
          ...
          <p style={styles.subtitle}>Acesse sua plataforma como {role === 'patient' ? 'Paciente' : 'Profissional'}</p>
          <form onSubmit={handleLogin} style={styles.form} noValidate>
            ...
            <button type="submit" style={{...styles.button}} onMouseOver={handleMouseOver} onMouseOut={handleMouseOut}>Entrar</button>
          </form>
          ...
          <p style={styles.loginLink} onClick={handleNavigateToRegister}>Não tem uma conta? Crie uma</p>
        </div>
      </div>
    );
};
