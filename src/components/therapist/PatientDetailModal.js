...
import Icons from '../common/Icons'; // ESTA LINHA FOI CORRIGIDA

const PatientDetailModal = ({ patient, onClose }) => {
    // Se nenhum paciente foi selecionado, não mostra nada.
    if (!patient) {
        return null;
    }
        ...
        <div style={styles.overlay} onClick={onClose}>
            <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
                <div style={styles.header}>
                    ...
                    {/* O XIcon não estava sendo usado aqui, então removi para evitar futuros erros */}
